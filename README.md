...
|---------------------|------------|----------------------------|
| **Фронтенд**        | HTML5, CSS3, JavaScripts | Пользовательский интерфейс |
...
- [Python 3.8+](https://ww.python.org/downloads/)
- [Git](https://github.com/nikitagordeev6c-wq/learn_project.git)
- Текстовый редактор (VS Code, SubTime Text, Notepad++)
